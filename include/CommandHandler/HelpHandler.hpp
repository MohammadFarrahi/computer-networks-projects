...
public:
  std::string USER =  "USER [name], Its argument is used to specify the user's string. It is used for user authentication.";
  std::string PASS =  "PASS [password], Its argument is used to specify the user's password. It is used for user authentication.";
  std::string PWD =  "PWD, It is used to print the name of the current working directory.";
  std::string MKD =  "MKD [path], Its argument is used to specify the directory's path. It is usede to create a new directory.";
  std::string DELE =  "DELE [flag] [path], Its argument is used to specify the file/directory's path. It flag is used to specify whether a file (-f) or a directory (-d) will be removed. It is usede to remove a file or directory.";
  std::string LS =  "LS. It is used to print the list of files/directories in the current working directory.";
  std::string CWD =  "CWD [path], Its argument is used to specify the directory's path. It is used to change the current working directory.";
  std::string RENAME =  "RENAME [from] [to], Its arguments are used to specify the old and new file's name. It is used to change A file's name.";
  std::string RETR =  "RETR [name], Its argument is used to specify the file's name. It is used to download a file.";
  std::string HELP =  "HELP, It is used to display information about builtin commands.";
  std::string QUIT =  "QUIT, It is used to sign out from the server.\n";
